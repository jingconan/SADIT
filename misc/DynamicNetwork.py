#!/usr/bin/env python
"""
The network environment is dynamic. Namely the norminal traffic pattern
is time-varying.

The dynamic traffic is simulated through:
    - simulate the traffic under stationary property
    - super impose the normal traffic to this.
"""

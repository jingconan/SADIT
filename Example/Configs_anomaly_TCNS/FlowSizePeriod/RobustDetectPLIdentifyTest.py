...
DIR = '/home/jzh/Dropbox/SaditTest/Robust_Method/PaperSimulation/FlowSizePeriod/'
        ...
        register_info = {
            ...
            'PeriodStaticDetector' : {
                ...
                'para' :  {
                    ...
                    'period': np.linspace(24*3600, 3*24*3600, 8),
                    'start': [0],
                    'delta_t':[1000, 1200, 1300, 1500, 2300],
                    },
                'para_type' : 'product',
                },
             },

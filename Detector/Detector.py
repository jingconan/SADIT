...
def model_based(qFeaVec, feaQN):
    ...
    m_list = get_feature_hash_list(qFeaVec, feaQN)
...
def vector_quantize_states(feaVec , feaQN, feaRange, quanFlag=None):
...
def get_all_pmf(feaVec, feaQN, feaRange,  quanFlag=None):
    ...
    # import pdb;pdb.set_trace()
    pmf = model_free(qFeaVec, feaQN)
    Pmb, mpmb = model_based(qFeaVec, feaQN)
    return pmf, Pmb, mpmb
...
def gen_norminal_pdf(fName, feaQN, dumpFlag =False):
    ...
    feaVec, feaRange, quanFlag, t, centerPt = get_feature(fName, feaQN[-1])
    ...
    pmf, Pmb, mpmb = get_all_pmf(n_feaVec, feaQN, feaRange,  quanFlag)
...
def detect(fName, feaQN, wSize):
    ...
    for i in range(detectNum):
        ...
        d_pmf, d_Pmb, d_mpmb = get_all_pmf(d_feaVec, feaQN, feaRange,  quanFlag)

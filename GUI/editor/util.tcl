...
proc upgradeNetworkConfigToServices { } {
    ...
    set vals "$vals {('/usr/local/etc/quagga/Quagga.conf', 'quaggaboot.sh')}"
...
proc popupAddressConfig { } {
	...
	frame $f.edit
	entry $f.edit.addr -bg white -width 15
...
proc listToTupleString { l } {
    ...
    set str "("
    # TODO: enforce proper quoting here
    foreach item $l {

#
# Copyright 2011-2012 the Boeing Company.
...
if { $execMode == "interactive" } {
    set g_img_cel [image create photo -file $LIBDIR/icons/tiny/cel.gif]
}
...
proc popupExceptions {} {
    ...
    ttk::button $w.btn.log -text "View cored log" \
	-command "popupFileView $CORE_STATE_DIR/log/coredpy.log"

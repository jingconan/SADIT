# -*- coding: utf-8 -*-
#
# SADIT documentation build configuration file, created by
...
project = u'SADIT'
copyright = u'2012, Jing Conan Wang'
...
latex_documents = [
  ('index', 'SADIT.tex', u'SADIT Documentation',
   u'Jing Conan Wang', 'manual'),
]
...
man_pages = [
    ('index', 'sadit', u'SADIT Documentation',
     [u'Jing Conan Wang'], 1)
]
...
texinfo_documents = [
  ('index', 'SADIT', u'SADIT Documentation',
   u'Jing Conan Wang', 'SADIT', 'One line description of project.',
   'Miscellaneous'),
]
